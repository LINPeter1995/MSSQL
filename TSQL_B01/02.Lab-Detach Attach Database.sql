...
--	資料庫匯出
--		資料庫(右鍵) Northwind(右鍵)→ 工作 → 匯出資料
--		資料來源 : Microsoft OLE DB Provider for SQL Server
--		目的地 : Microsoft Excel / csv Flat File Source → 路徑 → 檔名


--	資料庫匯入
--		資料庫Northwind(右鍵) → 工作 → 匯入資料
--		資料來源 : Microsoft Excel / csv Flat File Source → 檔案路徑
--		目的地 : Microsoft OLE DB Provider for SQL Server
