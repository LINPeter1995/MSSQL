 --	Module 11. 觸發程序(DML Triggers)的進階觀念、設計與實作    
 --		11-1:如何建立 INSTEAD OF Triggers     
 --		11-2:使用 UPDATE() 函數來判斷欄位值是否被修改    
 --		11-3:巢狀觸發程序(Nested Triggers) 的運作方式及其注意事項    
...
-- Populate the table
insert CurrentPrice (CurrentPriceID, SellingPrice) values (1, 2.3) ,  (2, 4.3) ,  (3, 5) ;
...
insert CurrentPrice (CurrentPriceID, SellingPrice, IsValid) values(4, 18.6, '1')
