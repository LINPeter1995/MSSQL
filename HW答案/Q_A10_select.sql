...
select CustomerID, CompanyName, ContactName, Phone, Country +' / '+Country as 'Counrty/City'
from Customers
...
select CustomerID, CompanyName, ContactName, Phone, City +' / '+Country as 'Counrty/City'
from Customers
