--	Module 6 使用一般的條件約束 (Constraints) 來實作資料的完整性
--		6-1 : DEFAULT 條件約束
--		6-2 : CHECK 條件約束
--		6-3 : Table-level constraint vs. Column-level constraint
...
create table Member (
	...
	MemEnable bit default 1            -- BIT 一種整數資料類型，其值有 1、0 或 NULL 幾種。
);
go
...
insert Member values (3, 'Tom', default)
