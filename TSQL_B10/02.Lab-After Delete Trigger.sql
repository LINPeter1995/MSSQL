--	Module 10	02. Lab - AFTER DELETE Trigger.sql
...
select * from Book
delete from Book where ISBN = 17
...
select * from Book
delete from Book where ISBN = 18
...
where BusinessEntityID = 280 ;					--275,  try 280  注意 : 資料有兩筆其中有一筆是 NULL 的情況發生
