--	Module 13.   探索視窗函數(Window Functions)    
--		13-1 : 透過 OVER 子句建立 SQL 視窗 (Windows)     
--		13-2 : 次序函數(Ranking functions)-RANK()、DENSE_RANK()、ROW_NUMBER()、
--				   NTILE() 的運用     
--		13-3 : 視窗型偏移(/位移)函數-分析函數-LAG()、LEAD()、FIRST_VALUE()、
--				   LAST_VALUE() 的運用     
