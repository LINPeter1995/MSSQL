...
drop function if exists func_05
...
alter function dbo.func_05 (@txt varchar(50)) 
returns int
as
begin
...
-- step 07 建一 函數 傳入 一整數'運費 freight'，在　Northwind.dbo.orders 中
-- 查詢運費大於 '運費 freight' 的所有欄位,  並由大到小排序找出前 10 列
