 --	Module 8 - DML指令的使用如何做資料的修改與刪除
--		8-1 : 使用 UPDATE 修改資料 
--		8-2 : 使用 DELETE 刪除資料  
--		8-3 : DELETE 指令與 TRUNCATE TABLE 指令的差別
...
set	TitleOfCourtesy = ne.TitleOfCourtesy,  -- error :  le.TitleOfCountesy 
		City = ne.City										--	請加入  LastName, First Name
from TempEmployees as le,  
		Northwind.dbo.Employees as ne
where le.EmployeeID=ne.EmployeeID       -- error : remove le.
