 --	Module 12  資料表(Tables) 的進階觀念、設計與實作
--		12-1: 透過系統檢視表(system views) 查詢Meta-Data
--		12-2: 搭配uniqueidentifier資料類型然後藉由NEWID()、NEWSEQUENTIALID()來產生GUID 的值
--		12-3: 關於timestamp 與rowversion資料類型的使用方式
