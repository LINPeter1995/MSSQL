 --	Module 5   資料庫的交易 (Transactions) 控制簡介
--			5-1: 交易(Transactions) 的 A.C.I.D. 四種屬性
--			5-2: SQL Server 主要的交易管理模式 (Transaction Management Mode)
--			5-3: @@TRANCOUNT 的值與 COMMIT、ROLLBACK 的關係
